...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert(
      ...
      [
        {
          order_id: userOrders['lucas@gmail.com']?.pending,
        ...
        {
          order_id: userOrders['renan@gmail.com']?.paid,
        ...
        {
          order_id: userOrders['eduardo@gmail.com']?.complete,
        ...
        {
          order_id: userOrders['joao@gmail.com']?.complete,
